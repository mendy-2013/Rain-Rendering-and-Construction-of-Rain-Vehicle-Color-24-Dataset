...
parser.add_argument("--logdir", type=str, default="/mnt/PReNet-master/logs/PReNet_test/", help='path to model and log files')
parser.add_argument("--data_path", type=str, default="/mnt/PReNet-master/datasets/test/input/", help='path to training data')
parser.add_argument("--save_path", type=str, default="/mnt/PReNet-master/results/", help='path to save results')
