...
parser.add_argument("--save_path", type=str, default="/mnt/PReNet/PReNet-master/logs/PReNet_test", help='path to save models and log files')
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="/mnt/PReNet/PReNet-master/datasets/train/RainTrainL",help='path to training data')
